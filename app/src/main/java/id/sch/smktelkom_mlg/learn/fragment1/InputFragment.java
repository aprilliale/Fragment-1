...
public class InputFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.buttonProses).setOnClickListener(new View.OnClickListener() {
    ...
    private void doProses() {
        if (mListener != null)
            mListener.doProses(etNama.getText().toString(), etUmur.getText().toString());
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof InputFragment.IListener) {
            ...
            throw new RuntimeException(context.toString() + " must implement InputFragment.IListener");
        }
    }
